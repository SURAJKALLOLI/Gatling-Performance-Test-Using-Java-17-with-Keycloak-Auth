    ...
    ScenarioBuilder scn = scenario("subscriptions")
            ...
            .exec(http("GET - Get Types")
                    ...
                    .header("Authorization", session -> {
                        return ((String) session.get("token_type")) + " " + ((String) session.get("access_token"));
                    }))
            ...
            .exec(
                    http("GET - Webhook data")
                            .get(session -> {System.out.println("Webhook URL: "+ "https://webhook.site/token/"+((String) session.get("webhook_uuid"))+"/request/latest" );
